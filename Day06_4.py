...
#定位初始节点
province = date_dict["areaTree"][0]["children"][3]["children"]

#更正市名称
for x in range(0,20):
    str1 = str(province[x]["name"])
    province[x]["name"] = str1 + "市"
...
map.set_global_opts(
    visualmap_opts=VisualMapOpts(
        ...
        pieces=[
            ...
            {"min": 100, "max": 500, "label": "100-300", "color": "#FF6666"},
            {"min": 500, "max": 1000, "label": "300-500", "color": "#990033"}
        ]
